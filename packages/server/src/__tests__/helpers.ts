...
export async function cleanDatabase(): Promise<void> {
  await db.execute(sql`TRUNCATE notification_channels, time_entries, task_links, webhook_deliveries, webhooks, activities, agent_sessions, comments, views, tasks, labels, projects, users CASCADE`);
}

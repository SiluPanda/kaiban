# Task: Documentation - README, Setup Guide, MCP Integration Guide
...
Write comprehensive documentation in the `docs/` directory and root README.
...
- CLAUDE.md for agent contributors
